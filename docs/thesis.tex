...
\begin{table}[h!] % Use [H] for exact placement, if necessary
    \centering
    \begin{tabular}{l c r}
    \textbf{Gene} & \textbf{Chains} & \textbf{Structures with Chain (%)} \\ \cline{1-3}
    Alice       & 24          & USA     \\
    Bob         & 30          & Canada  \\
    Catherine   & 28          & UK      \\
    \end{tabular}
